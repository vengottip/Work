...
# Prompt user for input CSV file and output CSV file
input_csv = input("Enter the input CSV file name (with .csv extension): ")
output_csv = input("Enter the output CSV file name (with .csv extension): ")
...
print(f"Filtered records have been written to {output_csv}")
